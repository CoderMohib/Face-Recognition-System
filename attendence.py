...
#========Variables=========
        ...
        AttendenceID_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_id,font=("times new roman",12))
        ...
        Roll_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_roll,font=("times new roman",12))
        ...
        Name_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_name,font=("times new roman",12))
        ...
        Department_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_dep,font=("times new roman",12))
        ...
        Time_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_time,font=("times new roman",12))
        ...
        Date_entry=ttk.Entry(left_inside_frame,width=15,textvariable=self.var_atten_date,font=("times new roman",12))
        ...
        Attendence_combo=ttk.Combobox(left_inside_frame,textvariable=self.var_atten_attendance,font=("times new roman",12),width=15,state="read only")
        ...
        Import_btn=Button(btn_frame,text="Import csv",command=self.importCsv,font=("times new roman",12,"bold"),width=13,bg="#000066",fg="white")
        Import_btn.grid(row=0,column=0,padx=8)

        Export_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,font=("times new roman",12,"bold"),width=13,bg="#000066",fg="white")
        Export_btn.grid(row=0,column=1,padx=6)

        Update_btn=Button(btn_frame,text="Update",command=self.update_data,font=("times new roman",12,"bold"),width=13,bg="#000066",fg="white")
...
#________________FACE DATA____________________
...
# import csv
    ...
    def update_data(self):
        try:
            selected_item = self.AttendenceReportTable.focus()  # Get the selected row
            if not selected_item:
                messagebox.showerror("Error", "No record selected for update", parent=self.root)
                return

            # Get the index of the selected item
            index = self.AttendenceReportTable.index(selected_item)

            # Update `mydata` with the new values from the input fields
            updated_row = [
            ...
            # Update the corresponding row in the `mydata` list
